<template>
	<div>
		<div><van-nav-bar title="实名认证" left-text="返回" left-arrow @click-left="goBack" :z-index="10" autosize fixed /></div>
		<div style="padding-top: 46px;">
			...
			<van-uploader :max-size="102400" @oversize="logContent('oversize')" :after-read="afterRead"><van-icon name="photograph" /></van-uploader>
...
export default {
	data() {
		return {
			username: '',
			code: '',
			imageList: ['https://img.yzcdn.cn/1.jpg']
		};
	},
	methods: {
		goBack() {
