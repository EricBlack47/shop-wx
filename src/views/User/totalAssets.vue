<template>
  <div >
	...
	<div style="padding-top: 46px;">
		<van-cell title="我的积分" icon="exchange" :value="userInfo.points" is-link to="/myMoney"  />
		<van-cell title="总返利" icon="exchange" :value="userInfo.pendingProfit" is-link to="/myMoney"  />
		<van-cell title="今日返利" icon="exchange" :value="userInfo.todayProfit " is-link to="/myMoney"  />
	</div>
	<van-tabs>
		<van-tab title="积分详情"><van-list>
				<div style="border-bottom: #999999 solid 1px;" v-for="(list, index) in listget" :key="index">
					<van-row>
						...
						<van-col span="6">{{list.type==8?"积分":list.type==4?"返利":"其他"}}</van-col>
						<van-col span="6">
